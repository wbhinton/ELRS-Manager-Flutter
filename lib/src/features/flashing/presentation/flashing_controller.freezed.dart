...
mixin _$FlashingState implements DiagnosticableTreeMixin {
 ...
 String? get selectedVendor; TargetDefinition? get selectedTarget; String? get selectedVersion; FlashingStatus get status; double get progress; String? get errorMessage; String get bindPhrase; String get wifiSsid; String get wifiPassword; int get regulatoryDomain; bool get dualBandEnabled; String? get autosavingField;
...
@useResult
$Res call({
 String? selectedVendor, TargetDefinition? selectedTarget, String? selectedVersion, FlashingStatus status, double progress, String? errorMessage, String bindPhrase, String wifiSsid, String wifiPassword, int regulatoryDomain, bool dualBandEnabled, String? autosavingField
});
...
as int,dualBandEnabled: null == dualBandEnabled ? _self.dualBandEnabled : dualBandEnabled // ignore: cast_nullable_to_non_nullable
as bool,autosavingField: freezed == autosavingField ? _self.autosavingField : autosavingField // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of FlashingState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? selectedVendor,  TargetDefinition? selectedTarget,  String? selectedVersion,  FlashingStatus status,  double progress,  String? errorMessage,  String bindPhrase,  String wifiSsid,  String wifiPassword,  int regulatoryDomain,  bool dualBandEnabled,  String? autosavingField)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FlashingState() when $default != null:
return $default(_that.selectedVendor,_that.selectedTarget,_that.selectedVersion,_that.status,_that.progress,_that.errorMessage,_that.bindPhrase,_that.wifiSsid,_that.wifiPassword,_that.regulatoryDomain,_that.dualBandEnabled,_that.autosavingField);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? selectedVendor,  TargetDefinition? selectedTarget,  String? selectedVersion,  FlashingStatus status,  double progress,  String? errorMessage,  String bindPhrase,  String wifiSsid,  String wifiPassword,  int regulatoryDomain,  bool dualBandEnabled,  String? autosavingField)  $default,) {final _that = this;
switch (_that) {
case _FlashingState():
return $default(_that.selectedVendor,_that.selectedTarget,_that.selectedVersion,_that.status,_that.progress,_that.errorMessage,_that.bindPhrase,_that.wifiSsid,_that.wifiPassword,_that.regulatoryDomain,_that.dualBandEnabled,_that.autosavingField);case _:
  throw StateError('Unexpected subclass');
...
class _FlashingState with DiagnosticableTreeMixin implements FlashingState {
  const _FlashingState({this.selectedVendor, this.selectedTarget, this.selectedVersion, this.status = FlashingStatus.idle, this.progress = 0.0, this.errorMessage, this.bindPhrase = '', this.wifiSsid = '', this.wifiPassword = '', this.regulatoryDomain = 0, this.dualBandEnabled = false, this.autosavingField});
...
@override@JsonKey() final  bool dualBandEnabled;
